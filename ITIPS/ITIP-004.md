...
protected within a designated review period. Thereafter they will be required to enable extensions for the protected module. The methodologist is free to revoke a module's protected status at any time. The table below shows the possible state conditions under this model.
